<%@page import="com.conway.pangpang.domain.User" %>
    ...
    <div class='navbar'>
        <div class='navbar-inner'>
            <div class='container-fluid'>
                <a class='brand' href='/pangpang/home'>
                ...
                <a class='toggle-nav btn pull-left' href='#'>
                 ...
                 <ul class='nav pull-right'>
                    ...
                    <li class='dropdown dark user-menu'>
                        <a class='dropdown-toggle' data-toggle='dropdown' href='#'>
                            <img alt='Mila Kunis' height='23' src='<c:url value="/images/avatar.jpg"/>' width='23' />
                            <span class='user-name hidden-phone'><%=userName %></span>
                            <b class='caret'></b>
                        </a>
                        <ul class='dropdown-menu'>
                            <li>
                                <a href='/pangpang/userProfile'>
                                    <i class='icon-user'></i>
                                    Profile
                                </a>
                            </li>
                            <li>
                                <a href='/pangpang/setting'>
                                    <i class='icon-cog'></i>
                                    Settings
                                </a>
                            </li>
